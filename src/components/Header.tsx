...
export default function Header() {
    ...
    { href: '/about', label: t('about') },
    {
      ...
      dropdown: [
        ...
        { 
          ...
          label: 'Credit Cards',
          description: 'Reward cards with exclusive benefits'
        },
        { 
          href: '/products/mortgages', 
          label: 'Mortgages',
          description: 'Home loans with great rates'
        },
      ],
    },
    {
  ...
  const activeDropdown = navLinks.find(link => link.href === openDropdown && link.dropdown);
                  ...
                  >
                    ...
                    >
                      <span className="relative flex items-center">
                        ...
                        <ChevronDown 
                          className={clsx(
                            ...
                            openDropdown === link.href ? 'rotate-180' : 'rotate-0'
                          )} 
                        />
                      </span>
                      {/* Active indicator */}
                      <div className={clsx(
                        ...
                        isActive ? 'w-full -translate-x-1/2' : 'w-0 -translate-x-1/2 group-hover:w-full'
                      )} />
                    </Link>
                  </div>
                );
          ...
          >
            <div className="container mx-auto px-6 lg:px-8 py-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {activeDropdown.dropdown?.map((item: any, index: number) => (
                  <Link
                    key={item.href}
                    href={item.href}
                    className={clsx(
                      'group block p-4 rounded-xl transition-all duration-200 ease-in-out hover:bg-gray-50 hover:shadow-md transform hover:-translate-y-1',
                      'animate-fadeInUp'
                    )}
                    style={{
