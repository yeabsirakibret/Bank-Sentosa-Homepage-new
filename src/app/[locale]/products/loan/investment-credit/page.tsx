...
export default function investmentCredit() {
      ...
      case 0:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold">{t("investment_credit")}</h2>
            <p>{t("investment_credit_paragraph")}</p>

            <button className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded mt-2">
              {t("investment_credit_cta")}
            </button>
          </div>
        );
      case 1:
        return (
          <div className="space-y-4">
            {messages.Global.investment_credit_requirements_list.map(
  ...
  return (
    <div className="w-full">
      {/* Banner */}
      <Banner
        imageSrc="/banner_6.png"
        altText="Main banner"
        heading={t("business_boost_heading")}
        subheading={t("business_boost_subheading")}
